...
public enum CrossroadParserServiceNotableEvents implements NotableEvent {
    E_UNEXPECTED_ERROR("Unexpected error for URL={} and region={}: {}"),
    E_RESPONSE_WRITING_ERROR("Failed to write response: {}"),
    E_INVALID_URL("Invalid URL: {}, region={}"),
    E_URL_FETCHING_ERROR("Did not manage to fetch URL={} for region={}: {}"),
    E_JSON_PROCESSING_ERROR("Unexpected JSON response from URL={}: {}"),
