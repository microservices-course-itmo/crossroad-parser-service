...
- выполните `docker-compose -f profiles/minimal-Infrastructure.yml -f profiles/crossroad-parser-service.yml up`
 
 При изменении версии в сервиса в pom файле нужно изменить версию приложения в crossroad-parser-service.yml
